...
@Component({
  selector: 'app-dict-confid',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './dict-confid.component.html',
  styleUrls: ['./dict-confid.component.css'],
})
export class DictConfidComponent implements OnInit, AfterViewInit {
