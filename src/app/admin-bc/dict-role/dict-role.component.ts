...
@Component({
  selector: 'app-dict-role',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './dict-role.component.html',
  styleUrls: ['./dict-role.component.css']
})
export class DictRoleComponent implements OnInit, AfterViewInit {
  roles: Role[] = [];
  deletedRoles: Role[] = [];
